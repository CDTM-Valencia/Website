...
const Index = () => {
	...
	return (
		<div className="min-h-[80vh] overflow-x-hidden bg-springPaleBlue">
			<Navbar
				backgroundColor={
					isApplicationsClosed ? "bg-white" : "bg-springPaleBlue/50"
				}
			/>
			...
			<div
				...
				<div
					...
					style={{
						background: isApplicationsClosed
